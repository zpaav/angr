...
void State::propagate_taints() {
	...
	block_taint_entry_t block_taint_entry = this->block_taint_cache.at(curr_block_details.block_addr);
...
bool State::is_block_exit_guard_symbolic() const {
	block_taint_entry_t block_taint_entry = block_taint_cache.at(curr_block_details.block_addr);
